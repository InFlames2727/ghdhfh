		...
		while(!valid || typeof valid === 'string') {
			...
			prompts.push(await msg.reply(stripIndents`
				...
				${oneLine`
							...
							Komutu İptal Etmek İçin with \`iptal\` yazın.. \`finish\`Otomatik olarak ${this.wait} saniye sonra iptal olucak this
			...
			while(!valid || typeof valid === 'string') {
				...
				if(value) {
					...
					prompts.push(await msg.reply(stripIndents`
						...
						${oneLine`
							Komutu İptal Etmek İçin with \`iptal\` yazın.. \`finish\`Otomatik olarak ${this.wait} saniye sonra iptal olucak this 
							${wait ? `Komut otomatik olarak iptal edilecektir ${this.wait} Sonra.` : ''}
						`}
					`));
